          ...
          <div className="max-w-[60ch] mx-auto">
            <div className="rounded-xl border border-[#3a3c3f] bg-[#2b2d2f]/60 backdrop-blur-sm px-5 py-4 space-y-3">
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                <Link href="/auth/register" className="inline-flex items-center justify-center h-8 px-4 rounded-full text-sm transition-colors border border-[#3a3c3f] text-[#d1d1d1] hover:bg-[#2b2d2f]">Registrar</Link>
              </div>
            </div>
          </div>
        )}
