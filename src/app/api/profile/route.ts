...
import { validateUpdateProfileRequest } from '@/api/dto/profile.dto';
...
export async function PUT(request: Request) {
  try {
    ...
    // Atualizar perfil
    const result = await updateProfile(authResult.userId, validation.normalized);
    ...
    console.error('Erro inesperado no route handler de profile:', err);
